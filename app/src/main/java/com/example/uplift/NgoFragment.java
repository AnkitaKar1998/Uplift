 ...
 * {@link NgoFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NgoFragment#newInstance} factory method to
...
public class NgoFragment extends Fragment {
     ...
     * @return A new instance of fragment NgoFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context=getContext();
        recyclerView=(RecyclerView)view.findViewById(R.id.ngo_rv);
    ...
    public void onStart() {
        ...
        Query query = databaseReference.orderByChild("type").equalTo("ngo");
